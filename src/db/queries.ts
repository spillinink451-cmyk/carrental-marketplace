...
export async function getBookingById(id: string) {
  const [row] = await db
    .select({
      ...
      pickupAt: bookings.pickupAt, dropoffAt: bookings.dropoffAt,
      ...
      cancellationDeadline: bookings.cancellationDeadline,
      driverName: bookings.driverName, 
      driverPhone: bookings.driverPhone, 
      driverCnic: bookings.driverCnic,
      driverNationality: bookings.driverNationality,
      driverAddress: bookings.driverAddress,
      driverLicenseType: bookings.driverLicenseType,
      driverLicenseNo: bookings.driverLicenseNo,
      driverLicenseIssueDate: bookings.driverLicenseIssueDate,
      carBrand: carBrands.name, 
      carModel: carModels.name, 
      companyName: companies.name,
      locationCity: cities.name, 
      locationAddress: branches.address,
      currency: companies.currency, 
